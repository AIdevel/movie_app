...
class Movie {
  ...
  num? _score;
  Show? _show;
Movie copyWith({  num? score,
  Show? show,
}) => Movie(  score: score ?? _score,
  show: show ?? _show,
);
...
Previousepisode previousepisodeFromJson(String str) => Previousepisode.fromJson(json.decode(str));
String previousepisodeToJson(Previousepisode data) => json.encode(data.toJson());
...
Externals externalsFromJson(String str) => Externals.fromJson(json.decode(str));
String externalsToJson(Externals data) => json.encode(data.toJson());
class Externals {
  Externals({
      dynamic tvrage, 
      num? thetvdb, 
